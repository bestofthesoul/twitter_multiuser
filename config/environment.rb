...
#       config.access_token        = API_KEYS["twitter_consumer_access_token_id"]
#       config.access_token_secret = API_KEYS["twitter_consumer_access_token_secret_id"]
# end

# TO ALLOW MULTI USER LOGGING IN, CLIENT IS NO LONGER GLOBAL VARIABLE, SINCE IT WILL CHANGE TO MULTI USERS
